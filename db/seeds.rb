...
User.create(:email => 'foodwebbuilder@gmail.com', :password => '12345678', :password_confirmation => '12345678', :role => 'admin', :approved => 1, :project_id =>1 )
...
User.create(:firstname => 'Project', :lastname => 'Lead', :username => 'lead', :email => 'lead@foodwebbuilder.com', :password => '12345678', :role => 'user', :approved => 1, :project_id =>1)


LocationData.create(latitude: 42.31276,longitude: -71.03645,location_id: 1,name: "UMASS BOSTON", :project_id =>1)
