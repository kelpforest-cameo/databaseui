...
task :production do
  role :web, "fwb@vm77.cs.umb.edu"   # Your HTTP server, Apache/etc (where your web server software runs)
  role :app, "fwb@vm77.cs.umb.edu"   # This may be the same as your `Web` server
